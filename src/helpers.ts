...
// Note, Sunder charms will not be generated by specifying player form TC + mlvl
export const canDropSunderCharm = (
  monsterFormState: MonsterFormState
): boolean => {
  return (
    monsterFormState.terrorZone &&
    (monsterFormState.monsterType === MonsterType.BOSS ||
      monsterFormState.monsterType === MonsterType.CHAMP ||
      monsterFormState.monsterType === MonsterType.UNIQUE ||
      monsterFormState.monsterType === MonsterType.SUPERUNIQUE)
  );
};
